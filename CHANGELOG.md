...
- `dyknow log` now works for the first read-only audit-viewer slice, reading `docs/dyknow/.state/audit-log.jsonl`, validating its JSONL entries, and pretty-printing the most recent review-action audit entries first.
