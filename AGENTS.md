...
## Development commands
  ...
  - `node packages/cli/dist/bin.js review --approve --page <page-id>` — persist approval, rejection, escalation, one edited proposal text, an explicit skip, or a targeted regenerate back into `docs/dyknow/.state/update-proposals.json` after a build.
  ...
  - `dyknow review` — persist approval, rejection, escalation, one edited proposal text, an explicit skip, or a targeted regenerate in `docs/dyknow/.state/update-proposals.json`
