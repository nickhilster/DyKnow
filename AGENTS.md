...
## Development commands
  ...
  - `node packages/cli/dist/bin.js review --approve --page <page-id>` — persist approval, rejection, escalation, one edited proposal text, or an explicit skip back into `docs/dyknow/.state/update-proposals.json` after a build.
  ...
  - `dyknow review` — persist approval, rejection, escalation, one edited proposal text, or an explicit skip in `docs/dyknow/.state/update-proposals.json`
