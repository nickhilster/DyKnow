...
2026-09-22 | update | AGENTS.md | Added the Cloud prototype packages (cloud-api, cloud-shared, cloud-web) to the architecture tree and summary, corrected the npm run build description, and listed the Cloud dev commands.
